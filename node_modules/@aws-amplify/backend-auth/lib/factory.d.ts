import { AmplifyAuth, AuthProps, TriggerEvent } from '@aws-amplify/auth-construct-alpha';
import { ConstructFactory, FunctionResources, ResourceProvider } from '@aws-amplify/plugin-types';
 ...
 */
export declare const defineAuth: (props: AmplifyAuthProps) => ConstructFactory<AmplifyAuth>;
