...
class RdsModelResourceGenerator extends model_resource_generator_1.ModelResourceGenerator {
    constructor() {
        ...
        this.generateDataSourceAndResourcesForStrategy = (context, strategy) => {
            ...
            const lambda = (0, rds_1.createRdsLambda)(lambdaScope, context.api, role, layerVersionArn, resourceNames, environment, strategy.vpcConfiguration, strategy.sqlLambdaProvisionedConcurrencyConfig);
