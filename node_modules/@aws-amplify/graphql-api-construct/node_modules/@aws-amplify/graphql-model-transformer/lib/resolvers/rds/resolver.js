...
const createRdsLambda = (scope, apiGraphql, lambdaRole, layerVersionArn, resourceNames, environment, sqlLambdaVpcConfig, sqlLambdaProvisionedConcurrencyConfig) => {
    var _a;
...
const addVpcEndpointForSecretsManager = (scope, sqlLambdaVpcConfig, resourceNames) => {
